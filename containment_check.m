...
r_gap_z = zeros(1,n_gap); % yz plane
r_gap_x = zeros(1,n_gap); % xy plane
d_gap = zeros(1,n_gap); % max extension of interface into fluid channel (i.e where the radii are calculated)
theta_xy = zeros(1,n_gap); % contact angle of interface in xy plane
theta_yz = zeros(1,n_gap); % same in yz plane
for i = 1:n_front
